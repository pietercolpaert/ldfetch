...
(async () => {
  ...
  try {
    ...
    await page.goto(base + '#url=' + encodeURIComponent(base + 'blank-nodes.ttl') + '&proxy=&pane=explore&view=map');
    ...
    await page.goto(base + '#url=' + encodeURIComponent(base + 'examples/visualization-showcase.ttl') + '&proxy=');
    await page.waitForFunction(() => document.querySelector('#status').textContent.startsWith('Done'));
    await page.click('#explore-tab');
    ...
    await page.goto(base + '#url=' + encodeURIComponent(base + 'examples/mol-tss-readings.trig') + '&proxy=&pane=explore&view=timeseries');
    ...
    await page.goto(base + '#url=' + encodeURIComponent(base + 'ldes.ttl') + '&proxy=&pane=explore&view=hypermedia');
    await page.reload({ waitUntil: 'domcontentloaded' });
    ...
    await page.goto(base + '#url=' + encodeURIComponent(base + 'large.trig') + '&proxy=&pane=explore&view=map&scope=window');
    await page.reload({ waitUntil: 'domcontentloaded' });
    await page.waitForFunction(() => document.querySelector('#status').textContent.startsWith('Done'));
    ...
    await page.goto(base + '#url=' + encodeURIComponent(base + 'prefixes.trig') + '&proxy=&pane=explore&view=profile');
    await page.waitForFunction(() => document.querySelector('#status').textContent.startsWith('Done'));
    ...
    await page.goto(base + '#url=' + encodeURIComponent(base + 'data.jelly.gz') + '&proxy=');
