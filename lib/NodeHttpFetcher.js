...
function HttpFetcher(accept, maxParallel, enableCache) {
...
HttpFetcher.prototype.request = function (url, methodName) {
    ...
    var headers = { 'Accept':  self._accept,
        ...
        executionResponse = function (res) {
          ...
          responseStream.on('end', function () {
            ...
            res.responseUrl = activeRequest.responseUrl;
  ...
  function onResponse(error, response, body) {
    ...
    var responseObject = { url: response.responseUrl, type: contentType, body: body, status: response.statusCode };
