...
function fetchForJsonLdContext () {
  if (typeof window === 'undefined' || !window.location || window.location.protocol !== 'https:') return globalThis.fetch;
...
function jsonLdDocumentLoader () {
  ...
  return new FetchDocumentLoader(fetchForJsonLdContext());
}
